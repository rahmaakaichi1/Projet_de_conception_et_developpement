                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Gestion Etudiant</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Bellili</td>
                        <td>Nourhene</td>
                        <td>nourhene.bellili@ensi-uma.tn</td>
                        <td>12345678</td>
                        <td>
                            <a href="#ModifierutilisateurModel" class="modifier" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="modifier">&#xE254;</i></a>
                            <a href="#SupprimerutilisateurModal" class="supprimer" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="supprimer">&#xE872;</i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>Ben Ahmed</td>
                        <td>Ilheme</td>
                        <td>ilheme.benahmed@ensi-uma.tn</td>
                        <td>14785236</td>
                        <td>
                            <a href="#ModifierutilisateurModel" class="modifier" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="modifier">&#xE254;</i></a>
                            <a href="#SupprimerutilisateurModal" class="supprimer" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="supprimer">&#xE872;</i></a>
