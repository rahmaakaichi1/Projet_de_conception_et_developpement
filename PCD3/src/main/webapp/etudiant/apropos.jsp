        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <!-- <a href="index.html" class="nav-brand">--><img src="/img/ensiLogo1.png" alt="">
                    ...
                    <div class="nav-content d-flex align-items-center">
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="/etudiant/apropos">A propos</a></li>
                                    <li><a href="/etudiant/contact">Contact</a></li>
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
                        ...
                        <div class="classynav">
                            ...
                            <ul>
                            <li><a href="#" ><i class="fa fa-user" aria-hidden="true"></i>PROFIL</a>
                           <div class="dropdown">
                                            <ul class="single-mega cn-col-4">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-8">
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <p> Ensi Scheduler est une application web qui vise à remedier à des difficultés rencontré sur le terrain lors de l'affectation des environnements aux enseignants.</p>
                        <p>En effet c'est un outil puissant permettant aux enseignants :</p>
                        <ul>
                            <li><i class="fa fa-check"></i> d'informer leurs étudiants d'un rattrapage après avoir trouver une salle libre à la date desirée.</li>
                            <li><i class="fa fa-check"></i> d'informer leurs étudiants de leurs absence à une date future.</li>
                            <li><i class="fa fa-check"></i> d'informer leurs étudiants qu'ils vont passer un Devoir Surveillée à une date donnée.</li>
