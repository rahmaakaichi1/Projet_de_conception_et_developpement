                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5>CHOISISSEZ L'HORAIRE QUI VOUS CONVIENT !</h5>
                        </div>

   <form:form method="POST" modelAttribute="suggestForm" action="${contextPath}/enseignant/enseignant_suggestion" class="form-signin">
       

        <div class="form-group ${error != null ? 'has-error' : ''}">
            <span>${message}</span>
            <c:forEach var="date" items="${dates }">
            <form:radiobutton path="Date_debut" type="text" class="form-control"></form:radiobutton>
            </c:forEach>
            <c:forEach var ="salle" items="${salles }">
             <form:radiobutton path="salle" type="text" class="form-control"></form:radiobutton>
             </c:forEach>
