                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Marquer Absence</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5>CREEZ VOTRE DEMANDE D'ABSENCE!</h5>
                        </div>

                      <form method="POST" action="${contextPath}/enseignant/absence" class="form-signin">
       

        <div class="form-group ${error != null ? 'has-error' : ''}">
            <span>${message}</span>
            <input name="raison" type="text" class="form-control" placeholder="Raison-Description">
            <input name="DateDebut" type="text" class="form-control" placeholder="DateDebut: dd/MM/yyyy">
             <input name="DateFin" type="text" class="form-control" placeholder="DateFin: dd/MM/yyyy">
            <span>${error}</span>
