				...
				<div class="col-12 col-lg-6">
					<div class="login-content bg-white p-30 box-shadow">
						...
						<form:form modelAttribute="EtudiantForm" method="post">
                            ...
                            <p> choisir Groupe : </p>
							<form:radiobutton path="groupe.groupeN" value="II-1-A" label="II-1-A"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-1-B" label="II-1-B"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-1-C" label="II-1-C"
								id="groupe.groupeN" />
								<form:radiobutton path="groupe.groupeN" value="II-1-D" label="II-1-D"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-1-E" label="II-1-E"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-1-F" label="II-1-F"
								id="groupe.groupeN" />
								</div>
								<div class="form-group" id="buttons">
							<form:radiobutton path="groupe.groupeN" value="II-2-A" label="II-2-A"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-2-B" label="II-2-B"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-2-C" label="II-2-C"
								id="groupe.groupeN" />
								<form:radiobutton path="groupe.groupeN" value="II-2-D" label="II-2-D"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-2-E" label="II-2-E"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-2-F" label="II-2-F"
								id="groupe.groupeN" />
								</div>
								<div class="form-group" id="buttons">
							<form:radiobutton path="groupe.groupeN" value="II-3-ILSI" label="II-3-ILSI"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-3-ISID" label="II-3-ISID"
								id="groupe.groupeN" />
							<form:radiobutton path="groupe.groupeN" value="II-3-IF" label="II-3-IF"
								id="groupe.groupeN" />
								<form:radiobutton path="groupe.groupeN" value="II-3-RSR" label="II-3-RSR"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-3-SLE" label="II-3-SLE"
								id="groupe.groupeN" />
								
								<form:radiobutton path="groupe.groupeN" value="II-3-II" label="II-3-II"
								id="groupe.groupeN" />
								</div>
							...
							<a href="connection"> <u>Déja un membre? </u></a><b style="word-space:5em">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><a href="inscription_enseignant"> <u>Vous  êtes enseignant? </u></a>
								</p>
							</div>
