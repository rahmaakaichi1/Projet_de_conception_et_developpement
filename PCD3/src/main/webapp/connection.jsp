...
<body>
    ...
    <div class="mag-login-area py-5">
                ...
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <div class="section-heading">
                            <h5>HEUREUX DE VOUS VOIR DE NOUVEAU!</h5>
                        </div>

                      <form method="POST" action="${contextPath}/connection" class="form-signin">
        ...
        <div class="form-group ${error != null ? 'has-error' : ''}">
            ...
            <button type="submit" class="btn btn-lg btn-primary btn-block mag-btn">Se Connecter</button>
            <div class="form-group">

								<p style="text-align: right;style="color:blue;">
									<a href="inscription.jsp"> <u>Besoin de s'inscrire ? </u></a>
								</p>
							</div>
        </div>
      </form>
